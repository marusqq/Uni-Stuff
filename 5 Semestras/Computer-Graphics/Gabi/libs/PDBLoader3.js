...
THREE.PDBLoader.prototype.parsePDB = function ( text ) {
	...
	var ASZ = {"h":1.2,"he":0.4,"li":0.694,"be":0.91,"b":1.08,"c":1.7,"n":1.55,"o":1.52,"f":1.47,
"ne":2.02,"na":2.23,"mg":2.43,"al":2.7,"si":2.8,"p":1.8,"s":1.8,"cl":1.75,"ar":3.99,"k":3.91,"ca":4.01,"sc":4.5,"ti":4.79,"v":5.09,"cr":5.2,"mn":5.49,"fe":5.59,"co":5.89,"ni":5.87,"cu":6.35,"zn":6.54,"ga":6.97,"ge":7.26,"as":7.49,"se":7.81,"br":7.99,"kr":8.48,"rb":8.45,"sr":8.76,"y":8.89,"zr":9.12,"nb":9.29,"mo":9.59,"tc":9.89,"ru":10.11,"rh":10.29,"pd":10.64,"ag":10.79,"cd":11.24,"in":11.48,"sn":11.87,"sb":12.18,"te":12.76,"i":12.69,"xe":13.13,"cs":13.29,"ba":13.73,"la":13.89,"ce":14.01,"pr":14.09,"nd":14.42,"pm":14.49,"sm":15.04,"eu":15.2,"gd":15.73,"tb":15.89,"dy":16.25,"ho":16.49,"er":16.73,"tm":16.89,"yb":17.3,"lu":17.5,"hf":17.85,"ta":18.09,"w":18.39,"re":16.82,"os":19.02,"ir":19.22,"pt":19.5,"au":19.7,"hg":20.06,"tl":20.44,"pb":20.72,"bi":20.9,"po":20.9,"at":20.99,"rn":22.2,"fr":22.3,"ra":22.6,"ac":22.7,"th":23.2,"pa":23.1,"u":23.8,"np":23.7,"pu":24.41,"am":24.31,"cm":24.71,"bk":24.71,"cf":25.11,"es":25.4,"fm":25.71,"md":25.81,"no":25.91,"lr":26.2,"rf":26.1,"db":26.2,"sg":26.6,"bh":26.4,"hs":26.9,"mt":26.8,
           "ds":26.9,"rg":27.2,"cn":27.7,"uut":0,"uuq":28.9,"uup":0,"uuh":29.8,"uus":0,"uuo":0};
    ...
    for( var i = 0, il = lines.length; i < il; ++ i ) {
        ...
        if( lines[i].substr(0,4)=="ATOM" || lines[i].substr(0,6)=="HETATM" ) {
            ...
            atoms.push( [ x,y,z, CPK[e],ASZ[e] , capitalize(e) ] );
...
THREE.PDBLoader.prototype.createModel = function ( json, callback ) {
	...
	for ( var i = 0; i < atoms.length; i ++ ) {
		...
		geometryAtoms.elements.push( atom[ 5 ] );
		geometryAtoms.elements_sizes.push( atom_size );
		//console.log(atom[ 4 ]);
	}
